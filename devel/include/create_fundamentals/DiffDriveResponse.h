...
bool operator==(const ::create_fundamentals::DiffDriveResponse_<ContainerAllocator1> & lhs, const ::create_fundamentals::DiffDriveResponse_<ContainerAllocator2> & rhs)
{
